...
void as7341_begin(measurements_mode mode);
bool as7341_enable(bool state);

bool as7341_enableLED(bool state);

bool set_bank(bool state);

void set_measurement_mode(measurements_mode mode);

bool set_ATIME(uint8_t value);
uint8_t get_ATIME();
bool set_ASTEP(uint16_t value1, uint16_t value2);
uint16_t get_ASTEP();
bool set_AGAIN(as7341_gain_t value);
as7341_gain_t get_AGAIN();

void enable_measurement(channel_t channel);
void set_F1F4ClearNIR();
void set_F5F8ClearNIR();
void init_flicker_detect();
void get_F1F4ClearNIR_data();
void get_F5F8ClearNIR_data();
bool enableSMUX(void);
bool enableSMUX_Interrupt(void);
bool set_SMUX_config(void);
...
uint8_t data;
if(state){
data = as7341_i2c_write(0x80, 0x01);
} else {
data = as7341_i2c_write(0x80, 0x00);
}
};
...
bool set_bank(bool state) {
if(state) {
as7341_i2c_write(0xA9, 1);
} else {
as7341_i2c_write(0xA9, 0);
};
};

bool enableSMUX(void) {
as7341_i2c_write(0x80, 0x11);
};
...
bool set_ASTEP(uint16_t value1, uint16_t value2) {
as7341_i2c_write(0xCA, value1);
as7341_i2c_write(0xCB, value2);
if(1){return 0;};
};
uint16_t get_ASTEP() {
...
as7341_i2c_write(0x02, 0x00);
as7341_i2c_write(0x03, 0x40);
as7341_i2c_write(0x04, 0x02);
as7341_i2c_write(0x05, 0x00);
as7341_i2c_write(0x06, 0x10);
as7341_i2c_write(0x07, 0x03);
as7341_i2c_write(0x08, 0x50);
as7341_i2c_write(0x09, 0x10);
as7341_i2c_write(0x0A, 0x03);
as7341_i2c_write(0x0B, 0x00);
as7341_i2c_write(0x0C, 0x00);
as7341_i2c_write(0x0D, 0x00);
as7341_i2c_write(0x0E, 0x24);
