...
typedef struct{
uint16_t ADC_CHANNEL_F1;
uint16_t ADC_CHANNEL_F2;
uint16_t ADC_CHANNEL_F3;
uint16_t ADC_CHANNEL_F4;
uint16_t ADC_CHANNEL_CLEAR;
uint16_t ADC_CHANNEL_NIR;
} F1F4_CLEAR_NIR_DATA_t;

typedef struct{
uint16_t ADC_CHANNEL_F5;
uint16_t ADC_CHANNEL_F6;
uint16_t ADC_CHANNEL_F7;
uint16_t ADC_CHANNEL_F8;
uint16_t ADC_CHANNEL_CLEAR;
uint16_t ADC_CHANNEL_NIR;
...
# 7 "/Applications/microchip/xc8/v2.40/pic/include/builtins.h"
...
# 109 "/Applications/microchip/xc8/v2.40/pic/include/proc/pic16f18425.h"
...
extern volatile unsigned char TMR3CON __at(0x214);

asm("TMR3CON equ 0214h");
...
extern volatile TMR3CONbits_t TMR3CONbits __at(0x214);
...
extern volatile unsigned char TMR3GCON __at(0x215);

asm("TMR3GCON equ 0215h");
...
extern volatile TMR3GCONbits_t TMR3GCONbits __at(0x215);
...
extern volatile unsigned char TMR5CON __at(0x21A);

asm("TMR5CON equ 021Ah");
...
extern volatile TMR5CONbits_t TMR5CONbits __at(0x21A);
...
extern volatile unsigned char TMR5GCON __at(0x21B);

asm("TMR5GCON equ 021Bh");
...
extern volatile TMR5GCONbits_t TMR5GCONbits __at(0x21B);
...
# 11951
extern volatile unsigned char ADCPCON0 __at(0x29F);

asm("ADCPCON0 equ 029Fh");
...
extern volatile ADCPCON0bits_t ADCPCON0bits __at(0x29F);
...
# 17151
extern volatile unsigned char CWG1CLK __at(0x60C);

asm("CWG1CLK equ 060Ch");
...
extern volatile CWG1CLKbits_t CWG1CLKbits __at(0x60C);
...
# 17970
extern volatile unsigned char CWG2CLK __at(0x616);

asm("CWG2CLK equ 0616h");
...
extern volatile CWG2CLKbits_t CWG2CLKbits __at(0x616);
...
extern volatile unsigned char CWG2DAT __at(0x617);

asm("CWG2DAT equ 0617h");
...
extern volatile CWG2DATbits_t CWG2DATbits __at(0x617);
...
# 19785
extern volatile unsigned char PMD6 __at(0x79C);
...
extern volatile PMD6bits_t PMD6bits __at(0x79C);

# 19818
extern volatile unsigned char PMD7 __at(0x79D);
...
extern volatile PMD7bits_t PMD7bits __at(0x79D);
...
# 21388
extern volatile unsigned char MD1CON0 __at(0x897);

asm("MD1CON0 equ 0897h");
...
extern volatile MD1CON0bits_t MD1CON0bits __at(0x897);

# 21456
extern volatile unsigned char MD1CON1 __at(0x898);

asm("MD1CON1 equ 0898h");
...
extern volatile MD1CON1bits_t MD1CON1bits __at(0x898);

# 21522
extern volatile unsigned char MD1SRC __at(0x899);

asm("MD1SRC equ 0899h");
...
extern volatile MD1SRCbits_t MD1SRCbits __at(0x899);

# 21614
extern volatile unsigned char MD1CARL __at(0x89A);

asm("MD1CARL equ 089Ah");
...
extern volatile MD1CARLbits_t MD1CARLbits __at(0x89A);

# 21694
extern volatile unsigned char MD1CARH __at(0x89B);

asm("MD1CARH equ 089Bh");
...
extern volatile MD1CARHbits_t MD1CARHbits __at(0x89B);
...
# 27415
extern volatile unsigned char T6INPPS __at(0x1E9E);

asm("T6INPPS equ 01E9Eh");
...
extern volatile T6INPPSbits_t T6INPPSbits __at(0x1E9E);
...
extern volatile __bit ACC20 __at(0x4C4);


extern volatile __bit ACC21 __at(0x4C5);


extern volatile __bit ACC22 __at(0x4C6);


extern volatile __bit ACC23 __at(0x4C7);
...
extern volatile __bit ACLR __at(0x89B);


extern volatile __bit ACQ0 __at(0x860);


extern volatile __bit ACQ1 __at(0x861);


extern volatile __bit ACQ10 __at(0x86A);


extern volatile __bit ACQ11 __at(0x86B);


extern volatile __bit ACQ12 __at(0x86C);


extern volatile __bit ACQ2 __at(0x862);


extern volatile __bit ACQ3 __at(0x863);


extern volatile __bit ACQ4 __at(0x864);


extern volatile __bit ACQ5 __at(0x865);


extern volatile __bit ACQ6 __at(0x866);


extern volatile __bit ACQ7 __at(0x867);


extern volatile __bit ACQ8 __at(0x868);


extern volatile __bit ACQ9 __at(0x869);


extern volatile __bit ACT0 __at(0x8B8);


extern volatile __bit ACT1 __at(0x8B9);


extern volatile __bit ACT2 __at(0x8BA);


extern volatile __bit ACT3 __at(0x8BB);


extern volatile __bit ACT4 __at(0x8BC);


extern volatile __bit ADACC0 __at(0x4B0);


extern volatile __bit ADACC1 __at(0x4B1);


extern volatile __bit ADACC10 __at(0x4BA);


extern volatile __bit ADACC11 __at(0x4BB);


extern volatile __bit ADACC12 __at(0x4BC);


extern volatile __bit ADACC13 __at(0x4BD);


extern volatile __bit ADACC14 __at(0x4BE);


extern volatile __bit ADACC15 __at(0x4BF);


extern volatile __bit ADACC16 __at(0x4C0);


extern volatile __bit ADACC17 __at(0x4C1);


extern volatile __bit ADACC18 __at(0x4C2);


extern volatile __bit ADACC19 __at(0x4C3);


extern volatile __bit ADACC2 __at(0x4B2);


extern volatile __bit ADACC20 __at(0x4C4);


extern volatile __bit ADACC21 __at(0x4C5);


extern volatile __bit ADACC22 __at(0x4C6);


extern volatile __bit ADACC23 __at(0x4C7);


extern volatile __bit ADACC3 __at(0x4B3);


extern volatile __bit ADACC4 __at(0x4B4);


extern volatile __bit ADACC5 __at(0x4B5);


extern volatile __bit ADACC6 __at(0x4B6);


extern volatile __bit ADACC7 __at(0x4B7);


extern volatile __bit ADACC8 __at(0x4B8);


extern volatile __bit ADACC9 __at(0x4B9);


extern volatile __bit ADACLR __at(0x89B);


extern volatile __bit ADACQ0 __at(0x860);


extern volatile __bit ADACQ1 __at(0x861);


extern volatile __bit ADACQ10 __at(0x86A);


extern volatile __bit ADACQ11 __at(0x86B);


extern volatile __bit ADACQ12 __at(0x86C);


extern volatile __bit ADACQ2 __at(0x862);


extern volatile __bit ADACQ3 __at(0x863);


extern volatile __bit ADACQ4 __at(0x864);


extern volatile __bit ADACQ5 __at(0x865);


extern volatile __bit ADACQ6 __at(0x866);


extern volatile __bit ADACQ7 __at(0x867);


extern volatile __bit ADACQ8 __at(0x868);


extern volatile __bit ADACQ9 __at(0x869);


extern volatile __bit ADACT0 __at(0x8B8);


extern volatile __bit ADACT1 __at(0x8B9);


extern volatile __bit ADACT2 __at(0x8BA);


extern volatile __bit ADACT3 __at(0x8BB);


extern volatile __bit ADACT4 __at(0x8BC);
...
extern volatile __bit ADAOV __at(0x8AF);


extern volatile __bit ADCALC0 __at(0x8A4);


extern volatile __bit ADCALC1 __at(0x8A5);


extern volatile __bit ADCALC2 __at(0x8A6);


extern volatile __bit ADCAP0 __at(0x870);


extern volatile __bit ADCAP1 __at(0x871);


extern volatile __bit ADCAP2 __at(0x872);


extern volatile __bit ADCAP3 __at(0x873);


extern volatile __bit ADCAP4 __at(0x874);


extern volatile __bit ADCMD __at(0x3CCD);


extern volatile __bit ADCNT0 __at(0x4C8);


extern volatile __bit ADCNT1 __at(0x4C9);


extern volatile __bit ADCNT2 __at(0x4CA);


extern volatile __bit ADCNT3 __at(0x4CB);


extern volatile __bit ADCNT4 __at(0x4CC);


extern volatile __bit ADCNT5 __at(0x4CD);


extern volatile __bit ADCNT6 __at(0x4CE);


extern volatile __bit ADCNT7 __at(0x4CF);


extern volatile __bit ADCONT __at(0x88E);


extern volatile __bit ADCRS0 __at(0x89C);


extern volatile __bit ADCRS1 __at(0x89D);


extern volatile __bit ADCRS2 __at(0x89E);


extern volatile __bit ADCS __at(0x88C);


extern volatile __bit ADCS0 __at(0x8C0);


extern volatile __bit ADCS1 __at(0x8C1);


extern volatile __bit ADCS2 __at(0x8C2);


extern volatile __bit ADCS3 __at(0x8C3);


extern volatile __bit ADCS4 __at(0x8C4);


extern volatile __bit ADCS5 __at(0x8C5);


extern volatile __bit ADDEN __at(0x8EB);


extern volatile __bit ADDSEN __at(0x890);


extern volatile __bit ADERR0 __at(0x480);


extern volatile __bit ADERR1 __at(0x481);


extern volatile __bit ADERR10 __at(0x48A);


extern volatile __bit ADERR11 __at(0x48B);


extern volatile __bit ADERR12 __at(0x48C);


extern volatile __bit ADERR13 __at(0x48D);


extern volatile __bit ADERR14 __at(0x48E);


extern volatile __bit ADERR15 __at(0x48F);


extern volatile __bit ADERR2 __at(0x482);


extern volatile __bit ADERR3 __at(0x483);


extern volatile __bit ADERR4 __at(0x484);


extern volatile __bit ADERR5 __at(0x485);


extern volatile __bit ADERR6 __at(0x486);


extern volatile __bit ADERR7 __at(0x487);


extern volatile __bit ADERR8 __at(0x488);


extern volatile __bit ADERR9 __at(0x489);


extern volatile __bit ADFLTR0 __at(0x4A0);


extern volatile __bit ADFLTR1 __at(0x4A1);


extern volatile __bit ADFLTR10 __at(0x4AA);


extern volatile __bit ADFLTR11 __at(0x4AB);


extern volatile __bit ADFLTR12 __at(0x4AC);


extern volatile __bit ADFLTR13 __at(0x4AD);


extern volatile __bit ADFLTR14 __at(0x4AE);


extern volatile __bit ADFLTR15 __at(0x4AF);


extern volatile __bit ADFLTR2 __at(0x4A2);


extern volatile __bit ADFLTR3 __at(0x4A3);


extern volatile __bit ADFLTR4 __at(0x4A4);


extern volatile __bit ADFLTR5 __at(0x4A5);


extern volatile __bit ADFLTR6 __at(0x4A6);


extern volatile __bit ADFLTR7 __at(0x4A7);


extern volatile __bit ADFLTR8 __at(0x4A8);


extern volatile __bit ADFLTR9 __at(0x4A9);


extern volatile __bit ADFM0 __at(0x88A);


extern volatile __bit ADFM1 __at(0x88B);
...
extern volatile __bit ADGAOE __at(0x894);


extern volatile __bit ADGBOE __at(0x893);


extern volatile __bit ADGO __at(0x888);


extern volatile __bit ADGPOL __at(0x895);
...
extern volatile __bit ADIPEN __at(0x896);


extern volatile __bit ADLTH0 __at(0x460);


extern volatile __bit ADLTH1 __at(0x461);


extern volatile __bit ADLTH10 __at(0x46A);


extern volatile __bit ADLTH11 __at(0x46B);


extern volatile __bit ADLTH12 __at(0x46C);


extern volatile __bit ADLTH13 __at(0x46D);


extern volatile __bit ADLTH14 __at(0x46E);


extern volatile __bit ADLTH15 __at(0x46F);


extern volatile __bit ADLTH2 __at(0x462);


extern volatile __bit ADLTH3 __at(0x463);


extern volatile __bit ADLTH4 __at(0x464);


extern volatile __bit ADLTH5 __at(0x465);


extern volatile __bit ADLTH6 __at(0x466);


extern volatile __bit ADLTH7 __at(0x467);


extern volatile __bit ADLTH8 __at(0x468);


extern volatile __bit ADLTH9 __at(0x469);


extern volatile __bit ADLTHR __at(0x8AD);


extern volatile __bit ADMATH __at(0x8AC);


extern volatile __bit ADMD0 __at(0x898);


extern volatile __bit ADMD1 __at(0x899);


extern volatile __bit ADMD2 __at(0x89A);
...
extern volatile __bit ADNREF0 __at(0x8B4);


extern volatile __bit ADNREF1 __at(0x8B5);


extern volatile __bit ADNREF2 __at(0x8B6);


extern volatile __bit ADNREF3 __at(0x8B7);


extern volatile __bit ADOEN __at(0x448A);


extern volatile __bit ADON __at(0x88F);


extern volatile __bit ADOR __at(0x4482);


extern volatile __bit ADOV __at(0x8AF);


extern volatile __bit ADPCH0 __at(0x4F8);


extern volatile __bit ADPCH1 __at(0x4F9);


extern volatile __bit ADPCH2 __at(0x4FA);


extern volatile __bit ADPCH3 __at(0x4FB);


extern volatile __bit ADPCH4 __at(0x4FC);


extern volatile __bit ADPCH5 __at(0x4FD);


extern volatile __bit ADPPOL __at(0x897);


extern volatile __bit ADPRE0 __at(0x878);


extern volatile __bit ADPRE1 __at(0x879);


extern volatile __bit ADPRE10 __at(0x882);


extern volatile __bit ADPRE11 __at(0x883);


extern volatile __bit ADPRE12 __at(0x884);


extern volatile __bit ADPRE2 __at(0x87A);


extern volatile __bit ADPRE3 __at(0x87B);


extern volatile __bit ADPRE4 __at(0x87C);


extern volatile __bit ADPRE5 __at(0x87D);


extern volatile __bit ADPRE6 __at(0x87E);


extern volatile __bit ADPRE7 __at(0x87F);


extern volatile __bit ADPRE8 __at(0x880);


extern volatile __bit ADPRE9 __at(0x881);


extern volatile __bit ADPREF0 __at(0x8B0);


extern volatile __bit ADPREF1 __at(0x8B1);


extern volatile __bit ADPREF2 __at(0x8B2);


extern volatile __bit ADPREF3 __at(0x8B3);


extern volatile __bit ADPREV0 __at(0x4D8);


extern volatile __bit ADPREV1 __at(0x4D9);


extern volatile __bit ADPREV10 __at(0x4E2);


extern volatile __bit ADPREV11 __at(0x4E3);


extern volatile __bit ADPREV12 __at(0x4E4);


extern volatile __bit ADPREV13 __at(0x4E5);


extern volatile __bit ADPREV14 __at(0x4E6);


extern volatile __bit ADPREV15 __at(0x4E7);


extern volatile __bit ADPREV2 __at(0x4DA);


extern volatile __bit ADPREV3 __at(0x4DB);


extern volatile __bit ADPREV4 __at(0x4DC);


extern volatile __bit ADPREV5 __at(0x4DD);


extern volatile __bit ADPREV6 __at(0x4DE);


extern volatile __bit ADPREV7 __at(0x4DF);


extern volatile __bit ADPREV8 __at(0x4E0);


extern volatile __bit ADPREV9 __at(0x4E1);


extern volatile __bit ADPSIS __at(0x89F);


extern volatile __bit ADRES0 __at(0x4E8);


extern volatile __bit ADRES1 __at(0x4E9);


extern volatile __bit ADRES10 __at(0x4F2);


extern volatile __bit ADRES11 __at(0x4F3);


extern volatile __bit ADRES12 __at(0x4F4);


extern volatile __bit ADRES13 __at(0x4F5);


extern volatile __bit ADRES14 __at(0x4F6);


extern volatile __bit ADRES15 __at(0x4F7);


extern volatile __bit ADRES2 __at(0x4EA);


extern volatile __bit ADRES3 __at(0x4EB);


extern volatile __bit ADRES4 __at(0x4EC);


extern volatile __bit ADRES5 __at(0x4ED);


extern volatile __bit ADRES6 __at(0x4EE);


extern volatile __bit ADRES7 __at(0x4EF);


extern volatile __bit ADRES8 __at(0x4F0);


extern volatile __bit ADRES9 __at(0x4F1);


extern volatile __bit ADRPT0 __at(0x4D0);


extern volatile __bit ADRPT1 __at(0x4D1);


extern volatile __bit ADRPT2 __at(0x4D2);


extern volatile __bit ADRPT3 __at(0x4D3);


extern volatile __bit ADRPT4 __at(0x4D4);


extern volatile __bit ADRPT5 __at(0x4D5);


extern volatile __bit ADRPT6 __at(0x4D6);


extern volatile __bit ADRPT7 __at(0x4D7);


extern volatile __bit ADSOI __at(0x8A3);


extern volatile __bit ADSTAT0 __at(0x8A8);


extern volatile __bit ADSTAT1 __at(0x8A9);


extern volatile __bit ADSTAT2 __at(0x8AA);


extern volatile __bit ADSTPT0 __at(0x490);


extern volatile __bit ADSTPT1 __at(0x491);


extern volatile __bit ADSTPT10 __at(0x49A);


extern volatile __bit ADSTPT11 __at(0x49B);


extern volatile __bit ADSTPT12 __at(0x49C);


extern volatile __bit ADSTPT13 __at(0x49D);


extern volatile __bit ADSTPT14 __at(0x49E);


extern volatile __bit ADSTPT15 __at(0x49F);


extern volatile __bit ADSTPT2 __at(0x492);


extern volatile __bit ADSTPT3 __at(0x493);


extern volatile __bit ADSTPT4 __at(0x494);


extern volatile __bit ADSTPT5 __at(0x495);


extern volatile __bit ADSTPT6 __at(0x496);


extern volatile __bit ADSTPT7 __at(0x497);


extern volatile __bit ADSTPT8 __at(0x498);


extern volatile __bit ADSTPT9 __at(0x499);
...
extern volatile __bit ADTMD0 __at(0x8A0);


extern volatile __bit ADTMD1 __at(0x8A1);


extern volatile __bit ADTMD2 __at(0x8A2);


extern volatile __bit ADUTH0 __at(0x470);


extern volatile __bit ADUTH1 __at(0x471);


extern volatile __bit ADUTH10 __at(0x47A);


extern volatile __bit ADUTH11 __at(0x47B);


extern volatile __bit ADUTH12 __at(0x47C);


extern volatile __bit ADUTH13 __at(0x47D);


extern volatile __bit ADUTH14 __at(0x47E);


extern volatile __bit ADUTH15 __at(0x47F);


extern volatile __bit ADUTH2 __at(0x472);


extern volatile __bit ADUTH3 __at(0x473);


extern volatile __bit ADUTH4 __at(0x474);


extern volatile __bit ADUTH5 __at(0x475);


extern volatile __bit ADUTH6 __at(0x476);


extern volatile __bit ADUTH7 __at(0x477);


extern volatile __bit ADUTH8 __at(0x478);


extern volatile __bit ADUTH9 __at(0x479);


extern volatile __bit ADUTHR __at(0x8AE);
...
extern volatile __bit AS __at(0x24D0);


extern volatile __bit ASYNC __at(0x2CFC);
...
extern volatile __bit BIT __at(0x44B8);
...
extern volatile __bit CALC0 __at(0x8A4);


extern volatile __bit CALC1 __at(0x8A5);


extern volatile __bit CALC2 __at(0x8A6);


extern volatile __bit CAP0 __at(0x870);


extern volatile __bit CAP1 __at(0x871);


extern volatile __bit CAP2 __at(0x872);


extern volatile __bit CAP3 __at(0x873);


extern volatile __bit CAP4 __at(0x874);
...
extern volatile __bit CCP1MD __at(0x3CD0);
...
extern volatile __bit CCP2MD __at(0x3CD1);
...
extern volatile __bit CCP3MD __at(0x3CD2);
...
extern volatile __bit CCP4MD __at(0x3CD3);
...
extern volatile __bit CH0 __at(0x44D8);


extern volatile __bit CH1 __at(0x44D9);


extern volatile __bit CH2 __at(0x44DA);


extern volatile __bit CH3 __at(0x44DB);


extern volatile __bit CHPOL __at(0x44C5);


extern volatile __bit CHSYNC __at(0x44C4);
...
extern volatile __bit CKPS3 __at(0x2CFB);


extern volatile __bit CKS0 __at(0x2C98);


extern volatile __bit CKS1 __at(0x2C99);


extern volatile __bit CKS2 __at(0x2C9A);


extern volatile __bit CKS3 __at(0x2C9B);


extern volatile __bit CL0 __at(0x44D0);


extern volatile __bit CL1 __at(0x44D1);


extern volatile __bit CL2 __at(0x44D2);


extern volatile __bit CL3 __at(0x44D3);
...
extern volatile __bit CLC1MD __at(0x3CE9);
...
extern volatile __bit CLC2MD __at(0x3CEA);
...
extern volatile __bit CLC3MD __at(0x3CEB);
...
extern volatile __bit CLC4MD __at(0x3CEC);
...
extern volatile __bit CLPOL __at(0x44C1);


extern volatile __bit CLSYNC __at(0x44C0);


extern volatile __bit CMP1MD __at(0x3CC9);


extern volatile __bit CMP2MD __at(0x3CCA);


extern volatile __bit CNT0 __at(0x4C8);


extern volatile __bit CNT1 __at(0x4C9);


extern volatile __bit CNT2 __at(0x4CA);


extern volatile __bit CNT3 __at(0x4CB);


extern volatile __bit CNT4 __at(0x4CC);


extern volatile __bit CNT5 __at(0x4CD);


extern volatile __bit CNT6 __at(0x4CE);


extern volatile __bit CNT7 __at(0x4CF);


extern volatile __bit CONT __at(0x88E);
...
extern volatile __bit CPOL __at(0x24C2);


extern volatile __bit CPON __at(0x14FF);


extern volatile __bit CPR0 __at(0x2478);


extern volatile __bit CPR1 __at(0x2479);


extern volatile __bit CPR10 __at(0x2482);


extern volatile __bit CPR11 __at(0x2483);


extern volatile __bit CPR12 __at(0x2484);


extern volatile __bit CPR13 __at(0x2485);


extern volatile __bit CPR14 __at(0x2486);


extern volatile __bit CPR15 __at(0x2487);


extern volatile __bit CPR16 __at(0x2488);


extern volatile __bit CPR17 __at(0x2489);


extern volatile __bit CPR18 __at(0x248A);


extern volatile __bit CPR19 __at(0x248B);


extern volatile __bit CPR2 __at(0x247A);


extern volatile __bit CPR20 __at(0x248C);


extern volatile __bit CPR21 __at(0x248D);


extern volatile __bit CPR22 __at(0x248E);


extern volatile __bit CPR23 __at(0x248F);


extern volatile __bit CPR3 __at(0x247B);


extern volatile __bit CPR4 __at(0x247C);


extern volatile __bit CPR5 __at(0x247D);


extern volatile __bit CPR6 __at(0x247E);


extern volatile __bit CPR7 __at(0x247F);


extern volatile __bit CPR8 __at(0x2480);


extern volatile __bit CPR9 __at(0x2481);


extern volatile __bit CPRDY __at(0x14F8);


extern volatile __bit CPRUP __at(0x24D7);


extern volatile __bit CPW0 __at(0x2490);


extern volatile __bit CPW1 __at(0x2491);


extern volatile __bit CPW10 __at(0x249A);


extern volatile __bit CPW11 __at(0x249B);


extern volatile __bit CPW12 __at(0x249C);


extern volatile __bit CPW13 __at(0x249D);


extern volatile __bit CPW14 __at(0x249E);


extern volatile __bit CPW15 __at(0x249F);


extern volatile __bit CPW16 __at(0x24A0);


extern volatile __bit CPW17 __at(0x24A1);


extern volatile __bit CPW18 __at(0x24A2);


extern volatile __bit CPW19 __at(0x24A3);


extern volatile __bit CPW2 __at(0x2492);


extern volatile __bit CPW20 __at(0x24A4);


extern volatile __bit CPW21 __at(0x24A5);


extern volatile __bit CPW22 __at(0x24A6);


extern volatile __bit CPW23 __at(0x24A7);


extern volatile __bit CPW3 __at(0x2493);


extern volatile __bit CPW4 __at(0x2494);


extern volatile __bit CPW5 __at(0x2495);


extern volatile __bit CPW6 __at(0x2496);


extern volatile __bit CPW7 __at(0x2497);


extern volatile __bit CPW8 __at(0x2498);


extern volatile __bit CPW9 __at(0x2499);


extern volatile __bit CPWUP __at(0x24D6);


extern volatile __bit CREN __at(0x8EC);


extern volatile __bit CRS0 __at(0x89C);


extern volatile __bit CRS1 __at(0x89D);


extern volatile __bit CRS2 __at(0x89E);


extern volatile __bit CS __at(0x88C);


extern volatile __bit CS5 __at(0x8C5);


extern volatile __bit CSEL0 __at(0x24D8);


extern volatile __bit CSEL1 __at(0x24D9);


extern volatile __bit CSEL2 __at(0x24DA);
...
extern volatile __bit CWG1LSDB0 __at(0x3094);


extern volatile __bit CWG1LSDB1 __at(0x3095);


extern volatile __bit CWG1MD __at(0x3CDD);
...
extern volatile __bit CWG2DAT0 __at(0x30B8);


extern volatile __bit CWG2DAT1 __at(0x30B9);


extern volatile __bit CWG2DAT2 __at(0x30BA);


extern volatile __bit CWG2DAT3 __at(0x30BB);
...
extern volatile __bit CWG2LSDB0 __at(0x30E4);


extern volatile __bit CWG2LSDB1 __at(0x30E5);


extern volatile __bit CWG2MD __at(0x3CDE);
...
extern volatile __bit DAC1MD __at(0x3CCE);
...
extern volatile __bit DONE __at(0x888);
...
extern volatile __bit DSEN __at(0x890);


extern volatile __bit DSM1MD __at(0x3CE8);
...
extern volatile __bit ERR0 __at(0x480);


extern volatile __bit ERR1 __at(0x481);


extern volatile __bit ERR10 __at(0x48A);


extern volatile __bit ERR11 __at(0x48B);


extern volatile __bit ERR12 __at(0x48C);


extern volatile __bit ERR13 __at(0x48D);


extern volatile __bit ERR14 __at(0x48E);


extern volatile __bit ERR15 __at(0x48F);


extern volatile __bit ERR2 __at(0x482);


extern volatile __bit ERR3 __at(0x483);


extern volatile __bit ERR4 __at(0x484);


extern volatile __bit ERR5 __at(0x485);


extern volatile __bit ERR6 __at(0x486);


extern volatile __bit ERR7 __at(0x487);


extern volatile __bit ERR8 __at(0x488);


extern volatile __bit ERR9 __at(0x489);
...
extern volatile __bit FLTR0 __at(0x4A0);


extern volatile __bit FLTR1 __at(0x4A1);


extern volatile __bit FLTR10 __at(0x4AA);


extern volatile __bit FLTR11 __at(0x4AB);


extern volatile __bit FLTR12 __at(0x4AC);


extern volatile __bit FLTR13 __at(0x4AD);


extern volatile __bit FLTR14 __at(0x4AE);


extern volatile __bit FLTR15 __at(0x4AF);


extern volatile __bit FLTR2 __at(0x4A2);


extern volatile __bit FLTR3 __at(0x4A3);


extern volatile __bit FLTR4 __at(0x4A4);


extern volatile __bit FLTR5 __at(0x4A5);


extern volatile __bit FLTR6 __at(0x4A6);


extern volatile __bit FLTR7 __at(0x4A7);


extern volatile __bit FLTR8 __at(0x4A8);


extern volatile __bit FLTR9 __at(0x4A9);


extern volatile __bit FM0 __at(0x88A);


extern volatile __bit FM1 __at(0x88B);
...
extern volatile __bit GAOE __at(0x894);


extern volatile __bit GBOE __at(0x893);
...
extern volatile __bit GO_nDONE __at(0x888);
...
extern volatile __bit INC0 __at(0x2C78);


extern volatile __bit INC1 __at(0x2C79);


extern volatile __bit INC10 __at(0x2C82);


extern volatile __bit INC11 __at(0x2C83);


extern volatile __bit INC12 __at(0x2C84);


extern volatile __bit INC13 __at(0x2C85);


extern volatile __bit INC14 __at(0x2C86);


extern volatile __bit INC15 __at(0x2C87);


extern volatile __bit INC16 __at(0x2C88);


extern volatile __bit INC17 __at(0x2C89);


extern volatile __bit INC18 __at(0x2C8A);


extern volatile __bit INC19 __at(0x2C8B);


extern volatile __bit INC2 __at(0x2C7A);


extern volatile __bit INC3 __at(0x2C7B);


extern volatile __bit INC4 __at(0x2C7C);


extern volatile __bit INC5 __at(0x2C7D);


extern volatile __bit INC6 __at(0x2C7E);


extern volatile __bit INC7 __at(0x2C7F);


extern volatile __bit INC8 __at(0x2C80);


extern volatile __bit INC9 __at(0x2C81);
...
extern volatile __bit IPEN __at(0x896);
...
extern volatile __bit LATA3 __at(0xC3);
...
extern volatile __bit LTH0 __at(0x460);


extern volatile __bit LTH1 __at(0x461);


extern volatile __bit LTH10 __at(0x46A);


extern volatile __bit LTH11 __at(0x46B);


extern volatile __bit LTH12 __at(0x46C);


extern volatile __bit LTH13 __at(0x46D);


extern volatile __bit LTH14 __at(0x46E);


extern volatile __bit LTH15 __at(0x46F);


extern volatile __bit LTH2 __at(0x462);


extern volatile __bit LTH3 __at(0x463);


extern volatile __bit LTH4 __at(0x464);


extern volatile __bit LTH5 __at(0x465);


extern volatile __bit LTH6 __at(0x466);


extern volatile __bit LTH7 __at(0x467);


extern volatile __bit LTH8 __at(0x468);


extern volatile __bit LTH9 __at(0x469);


extern volatile __bit LTHR __at(0x8AD);


extern volatile __bit LWLO __at(0x40F5);


extern volatile __bit MATH __at(0x8AC);
...
extern volatile __bit MD0 __at(0x898);


extern volatile __bit MD1 __at(0x899);


extern volatile __bit MD16 __at(0x2CF4);


extern volatile __bit MD1BIT __at(0x44B8);


extern volatile __bit MD1CH0 __at(0x44D8);


extern volatile __bit MD1CH1 __at(0x44D9);


extern volatile __bit MD1CH2 __at(0x44DA);


extern volatile __bit MD1CH3 __at(0x44DB);


extern volatile __bit MD1CHPOL __at(0x44C5);


extern volatile __bit MD1CHSYNC __at(0x44C4);


extern volatile __bit MD1CL0 __at(0x44D0);


extern volatile __bit MD1CL1 __at(0x44D1);


extern volatile __bit MD1CL2 __at(0x44D2);


extern volatile __bit MD1CL3 __at(0x44D3);


extern volatile __bit MD1CLPOL __at(0x44C1);


extern volatile __bit MD1CLSYNC __at(0x44C0);


extern volatile __bit MD1EN __at(0x44BF);


extern volatile __bit MD1MS0 __at(0x44C8);


extern volatile __bit MD1MS1 __at(0x44C9);


extern volatile __bit MD1MS2 __at(0x44CA);


extern volatile __bit MD1MS3 __at(0x44CB);


extern volatile __bit MD1MS4 __at(0x44CC);


extern volatile __bit MD1OPOL __at(0x44BC);


extern volatile __bit MD1OUT __at(0x44BD);


extern volatile __bit MD2 __at(0x89A);
...
extern volatile __bit MS0 __at(0x44C8);


extern volatile __bit MS1 __at(0x44C9);


extern volatile __bit MS2 __at(0x44CA);


extern volatile __bit MS3 __at(0x44CB);


extern volatile __bit MS4 __at(0x44CC);
...
extern volatile __bit MSSP1MD __at(0x3CE0);


extern volatile __bit MSSP2MD __at(0x3CE1);
...
extern volatile __bit NCO1CKS0 __at(0x2C98);


extern volatile __bit NCO1CKS1 __at(0x2C99);


extern volatile __bit NCO1CKS2 __at(0x2C9A);


extern volatile __bit NCO1CKS3 __at(0x2C9B);


extern volatile __bit NCO1EN __at(0x2C97);
...
extern volatile __bit NCO1MD __at(0x3CC7);


extern volatile __bit NCO1OUT __at(0x2C95);


extern volatile __bit NCO1PFM __at(0x2C90);


extern volatile __bit NCO1POL __at(0x2C94);


extern volatile __bit NCO1PWS0 __at(0x2C9D);


extern volatile __bit NCO1PWS1 __at(0x2C9E);


extern volatile __bit NCO1PWS2 __at(0x2C9F);
...
extern volatile __bit NOT_T1DONE __at(0x107B);


extern volatile __bit NOT_T1SYNC __at(0x1072);


extern volatile __bit NOT_T3DONE __at(0x10AB);


extern volatile __bit NOT_T3SYNC __at(0x10A2);


extern volatile __bit NOT_T5DONE __at(0x10DB);


extern volatile __bit NOT_T5SYNC __at(0x10D2);


extern volatile __bit NREF0 __at(0x8B4);


extern volatile __bit NREF1 __at(0x8B5);


extern volatile __bit NREF2 __at(0x8B6);


extern volatile __bit NREF3 __at(0x8B7);
...
extern volatile __bit OPOL __at(0x44BC);
...
extern volatile __bit OV __at(0x8AF);


extern volatile __bit PCH3 __at(0x4FB);


extern volatile __bit PCH4 __at(0x4FC);


extern volatile __bit PCH5 __at(0x4FD);
...
extern volatile __bit PFM __at(0x2C90);


extern volatile __bit PLLR __at(0x4480);


extern volatile __bit PPOL __at(0x897);


extern volatile __bit PPSLOCKED __at(0xF478);


extern volatile __bit PR1 __at(0x24A9);


extern volatile __bit PR10 __at(0x24B2);


extern volatile __bit PR11 __at(0x24B3);


extern volatile __bit PR12 __at(0x24B4);


extern volatile __bit PR13 __at(0x24B5);


extern volatile __bit PR14 __at(0x24B6);


extern volatile __bit PR15 __at(0x24B7);


extern volatile __bit PR16 __at(0x24B8);


extern volatile __bit PR17 __at(0x24B9);


extern volatile __bit PR18 __at(0x24BA);


extern volatile __bit PR19 __at(0x24BB);


extern volatile __bit PR20 __at(0x24BC);


extern volatile __bit PR21 __at(0x24BD);


extern volatile __bit PR22 __at(0x24BE);


extern volatile __bit PR23 __at(0x24BF);


extern volatile __bit PR3 __at(0x24AB);


extern volatile __bit PR5 __at(0x24AD);


extern volatile __bit PR7 __at(0x24AF);


extern volatile __bit PR8 __at(0x24B0);


extern volatile __bit PR9 __at(0x24B1);


extern volatile __bit PRE0 __at(0x878);


extern volatile __bit PRE1 __at(0x879);


extern volatile __bit PRE10 __at(0x882);


extern volatile __bit PRE11 __at(0x883);


extern volatile __bit PRE12 __at(0x884);


extern volatile __bit PRE2 __at(0x87A);


extern volatile __bit PRE3 __at(0x87B);


extern volatile __bit PRE4 __at(0x87C);


extern volatile __bit PRE5 __at(0x87D);


extern volatile __bit PRE6 __at(0x87E);


extern volatile __bit PRE7 __at(0x87F);


extern volatile __bit PRE8 __at(0x880);


extern volatile __bit PRE9 __at(0x881);


extern volatile __bit PREF0 __at(0x8B0);


extern volatile __bit PREF1 __at(0x8B1);


extern volatile __bit PREF2 __at(0x8B2);


extern volatile __bit PREF3 __at(0x8B3);


extern volatile __bit PREV0 __at(0x4D8);


extern volatile __bit PREV1 __at(0x4D9);


extern volatile __bit PREV10 __at(0x4E2);


extern volatile __bit PREV11 __at(0x4E3);


extern volatile __bit PREV12 __at(0x4E4);


extern volatile __bit PREV13 __at(0x4E5);


extern volatile __bit PREV14 __at(0x4E6);


extern volatile __bit PREV15 __at(0x4E7);


extern volatile __bit PREV2 __at(0x4DA);


extern volatile __bit PREV3 __at(0x4DB);


extern volatile __bit PREV4 __at(0x4DC);


extern volatile __bit PREV5 __at(0x4DD);


extern volatile __bit PREV6 __at(0x4DE);


extern volatile __bit PREV7 __at(0x4DF);


extern volatile __bit PREV8 __at(0x4E0);


extern volatile __bit PREV9 __at(0x4E1);


extern volatile __bit PS0 __at(0x24C0);


extern volatile __bit PS1 __at(0x24C1);
...
extern volatile __bit PSIS __at(0x89F);
...
extern volatile __bit PWM6MD __at(0x3CD5);
...
extern volatile __bit PWM7MD __at(0x3CD6);
...
extern volatile __bit PWS0 __at(0x2C9D);


extern volatile __bit PWS1 __at(0x2C9E);


extern volatile __bit PWS2 __at(0x2C9F);
...
extern volatile __bit REPEAT __at(0x24CE);


extern volatile __bit RES0 __at(0x4E8);


extern volatile __bit RES1 __at(0x4E9);


extern volatile __bit RES10 __at(0x4F2);


extern volatile __bit RES11 __at(0x4F3);


extern volatile __bit RES12 __at(0x4F4);


extern volatile __bit RES13 __at(0x4F5);


extern volatile __bit RES14 __at(0x4F6);


extern volatile __bit RES15 __at(0x4F7);


extern volatile __bit RES2 __at(0x4EA);


extern volatile __bit RES3 __at(0x4EB);


extern volatile __bit RES4 __at(0x4EC);


extern volatile __bit RES5 __at(0x4ED);


extern volatile __bit RES6 __at(0x4EE);


extern volatile __bit RES7 __at(0x4EF);


extern volatile __bit RES8 __at(0x4F0);


extern volatile __bit RES9 __at(0x4F1);


extern volatile __bit ROI __at(0x4465);


extern volatile __bit RPT0 __at(0x4D0);


extern volatile __bit RPT1 __at(0x4D1);


extern volatile __bit RPT2 __at(0x4D2);


extern volatile __bit RPT3 __at(0x4D3);


extern volatile __bit RPT4 __at(0x4D4);


extern volatile __bit RPT5 __at(0x4D5);


extern volatile __bit RPT6 __at(0x4D6);


extern volatile __bit RPT7 __at(0x4D7);
...
extern volatile __bit RST __at(0x24D5);
...
extern volatile __bit SMT1MD __at(0x3CED);
...
extern volatile __bit SMT1SIGPPS0 __at(0xF550);


extern volatile __bit SMT1SIGPPS1 __at(0xF551);


extern volatile __bit SMT1SIGPPS2 __at(0xF552);


extern volatile __bit SMT1SIGPPS3 __at(0xF553);


extern volatile __bit SMT1SIGPPS4 __at(0xF554);
...
extern volatile __bit SMT1WINPPS0 __at(0xF548);


extern volatile __bit SMT1WINPPS1 __at(0xF549);


extern volatile __bit SMT1WINPPS2 __at(0xF54A);


extern volatile __bit SMT1WINPPS3 __at(0xF54B);


extern volatile __bit SMT1WINPPS4 __at(0xF54C);
...
extern volatile __bit SOI __at(0x8A3);
...
extern volatile __bit SPOL __at(0x24C3);


extern volatile __bit SREN __at(0x8ED);


extern volatile __bit SSEL0 __at(0x24E0);


extern volatile __bit SSEL1 __at(0x24E1);


extern volatile __bit SSEL2 __at(0x24E2);


extern volatile __bit SSEL3 __at(0x24E3);


extern volatile __bit SSEL4 __at(0x24E4);
...
extern volatile __bit STAT0 __at(0x8A8);


extern volatile __bit STAT1 __at(0x8A9);


extern volatile __bit STAT2 __at(0x8AA);
...
extern volatile __bit STP __at(0x24C5);


extern volatile __bit STPT0 __at(0x490);


extern volatile __bit STPT1 __at(0x491);


extern volatile __bit STPT10 __at(0x49A);


extern volatile __bit STPT11 __at(0x49B);


extern volatile __bit STPT12 __at(0x49C);


extern volatile __bit STPT13 __at(0x49D);


extern volatile __bit STPT15 __at(0x49E);


extern volatile __bit STPT16 __at(0x49F);


extern volatile __bit STPT2 __at(0x492);


extern volatile __bit STPT3 __at(0x493);


extern volatile __bit STPT4 __at(0x494);


extern volatile __bit STPT5 __at(0x495);


extern volatile __bit STPT6 __at(0x496);


extern volatile __bit STPT7 __at(0x497);


extern volatile __bit STPT8 __at(0x498);


extern volatile __bit STPT9 __at(0x499);
...
extern volatile __bit T0MD16 __at(0x2CF4);
...
extern volatile __bit T1CS4 __at(0x108C);
...
extern volatile __bit T3CS4 __at(0x10BC);
...
extern volatile __bit T4INPPS0 __at(0xF4E8);


extern volatile __bit T4INPPS1 __at(0xF4E9);


extern volatile __bit T4INPPS2 __at(0xF4EA);


extern volatile __bit T4INPPS3 __at(0xF4EB);


extern volatile __bit T4INPPS4 __at(0xF4EC);
...
extern volatile __bit T5CKIPP3 __at(0xF4B3);
...
extern volatile __bit T5CS4 __at(0x10EC);
...
extern volatile __bit T6INPPS0 __at(0xF4F0);


extern volatile __bit T6INPPS1 __at(0xF4F1);


extern volatile __bit T6INPPS2 __at(0xF4F2);


extern volatile __bit T6INPPS3 __at(0xF4F3);


extern volatile __bit T6INPPS4 __at(0xF4F4);
...
extern volatile __bit TMD0 __at(0x8A0);


extern volatile __bit TMD1 __at(0x8A1);


extern volatile __bit TMD2 __at(0x8A2);
...
extern volatile __bit TMR1 __at(0x2461);


extern volatile __bit TMR10 __at(0x246A);


extern volatile __bit TMR11 __at(0x246B);


extern volatile __bit TMR12 __at(0x246C);


extern volatile __bit TMR13 __at(0x246D);


extern volatile __bit TMR14 __at(0x246E);


extern volatile __bit TMR15 __at(0x246F);


extern volatile __bit TMR16 __at(0x2470);


extern volatile __bit TMR17 __at(0x2471);


extern volatile __bit TMR18 __at(0x2472);


extern volatile __bit TMR19 __at(0x2473);
...
extern volatile __bit TMR20 __at(0x2474);


extern volatile __bit TMR21 __at(0x2475);


extern volatile __bit TMR22 __at(0x2476);


extern volatile __bit TMR23 __at(0x2477);
...
extern volatile __bit TMR3 __at(0x2463);
...
extern volatile __bit TMR5 __at(0x2465);
...
extern volatile __bit TMR7 __at(0x2467);


extern volatile __bit TMR8 __at(0x2468);


extern volatile __bit TMR9 __at(0x2469);
...
extern volatile __bit TRISA3 __at(0x93);
...
extern volatile __bit TS __at(0x24D2);
...
extern volatile __bit U1MD __at(0x3CE4);
...
extern volatile __bit UTH0 __at(0x470);


extern volatile __bit UTH1 __at(0x471);


extern volatile __bit UTH10 __at(0x47A);


extern volatile __bit UTH11 __at(0x47B);


extern volatile __bit UTH12 __at(0x47C);


extern volatile __bit UTH13 __at(0x47D);


extern volatile __bit UTH14 __at(0x47E);


extern volatile __bit UTH15 __at(0x47F);


extern volatile __bit UTH2 __at(0x472);


extern volatile __bit UTH3 __at(0x473);


extern volatile __bit UTH4 __at(0x474);


extern volatile __bit UTH5 __at(0x475);


extern volatile __bit UTH6 __at(0x476);


extern volatile __bit UTH7 __at(0x477);


extern volatile __bit UTH8 __at(0x478);


extern volatile __bit UTH9 __at(0x479);


extern volatile __bit UTHR __at(0x8AE);
...
extern volatile __bit WPOL __at(0x24C4);
...
extern volatile __bit WS __at(0x24D1);


extern volatile __bit WSEL0 __at(0x24E8);


extern volatile __bit WSEL1 __at(0x24E9);


extern volatile __bit WSEL2 __at(0x24EA);


extern volatile __bit WSEL3 __at(0x24EB);


extern volatile __bit WSEL4 __at(0x24EC);
...
extern volatile __bit ZCDMD __at(0x3CC8);
...
# 76 "/Applications/microchip/xc8/v2.40/pic/include/pic.h"
...
# 114 "/Applications/microchip/xc8/v2.40/pic/include/eeprom_routines.h"
extern void eeprom_write(unsigned char addr, unsigned char value);
extern unsigned char eeprom_read(unsigned char addr);

# 118 "/Applications/microchip/xc8/v2.40/pic/include/pic.h"
...
void as7341_init(eMode_t mode) {
uint8_t as7341_id = as7341_i2c_read(0x92);
if(as7341_id != 0) {
printf("Could not find AS7341, Try to find again\r\n");
} else {
as7341_power_enable(1);
...
# 48
void as7341_power_enable(bool state) {
uint8_t regVal = as7341_i2c_read(0x80);
regVal = (state == 1) ? regVal | (1<<0) : regVal & (~1);
uint8_t flag = as7341_i2c_write(0x80, regVal);
...
void enable_sp_en(bool state) {
uint8_t regVal = as7341_i2c_read(0x80);
as7341_i2c_write(0x80, (state ? (regVal | (1<<1)) : regVal & (~(1<<1))));
};
...
as7341_i2c_write(0x00, 0x00);
as7341_i2c_write(0x01, 0x00);
as7341_i2c_write(0x02, 0x00);
as7341_i2c_write(0x03, 0x00);
as7341_i2c_write(0x04, 0x00);
as7341_i2c_write(0x05, 0x00);
as7341_i2c_write(0x06, 0x00);
as7341_i2c_write(0x07, 0x00);
as7341_i2c_write(0x08, 0x00);
as7341_i2c_write(0x09, 0x00);
as7341_i2c_write(0x0A, 0x00);
as7341_i2c_write(0x0B, 0x00);
as7341_i2c_write(0x0C, 0x00);
as7341_i2c_write(0x0D, 0x00);
as7341_i2c_write(0x0E, 0x00);
as7341_i2c_write(0x0F, 0x00);
as7341_i2c_write(0x10, 0x00);
as7341_i2c_write(0x11, 0x00);
as7341_i2c_write(0x12, 0x00);
as7341_i2c_write(0x13, 0x60);
};

void as7341_start_measurement(channel_t channel) {
uint8_t data = 0;
data = as7341_i2c_read(0xA9);
data = data & (~(1<<4));
as7341_i2c_write(0xA9, data);

enable_sp_en(0);
as7341_smux_cmd_config();
...
data[0] = as7341_i2c_read(0x95 + channel*2);
data[1] = as7341_i2c_read(0x96 + channel*2);
channelData = data[1];
...
as7341_i2c_write(0xAF, 0x10);
};

# 297
void set_GPIO_mode(uint8_t mode) {
uint8_t data;
data = as7341_i2c_read(0xBE);
...
bool set_bank(bool state) {
uint8_t regVal = as7341_i2c_read(0xA9);
if(state == 1) {
regVal = regVal | (1<<4);
} else {
regVal = regVal & (~(1<<4));
};
as7341_i2c_write(0xA9, regVal);
};

bool set_ATIME(uint8_t value) {
as7341_i2c_write(0x81, value);
};
...
high_value = value >> 8 ;
as7341_i2c_write(0xCA, low_value);
as7341_i2c_write(0xCB, high_value);
...
# 356
set_bank(1);
bool result = as7341_i2c_write(0x74, 0x98);
set_bank(0);
return result;
};
...
set_bank(1);
data = as7341_i2c_read(0x70);
data1 = as7341_i2c_read(0x74);
if(state == 1) {
data = data | 0x08;
} else {
data = data & 0xF7;
data1 = data1 & 0x7F;
as7341_i2c_write(0x74, data1);
}
as7341_i2c_write(0x70, data);
set_bank(0);
};
...
# 408
void is_as7341_interrupt() {
uint8_t data = as7341_i2c_read(0x93);
if(data & 0x80){
...
# 422
void clear_interrupt(){
as7341_i2c_write(0x93, 0xFF);
};

# 430
void enable_spectral_interrupt(bool state) {
uint8_t data;
data = as7341_i2c_read(0xF9);
if(state == 1) {
data = data | (1<<3);
as7341_i2c_write(0xF9,data);
} else {
data = data & (~(1<<3));
as7341_i2c_write(0xF9,data);
};
...
as7341_i2c_write(0x84,low_threshold);
as7341_i2c_write(0x85,low_threshold>>8);
as7341_i2c_write(0x86,hight_threshold);
as7341_i2c_write(0x87,hight_threshold>>8);
...
# 484
void set_spectral_threshold_channel(uint8_t value) {
as7341_i2c_write(0xB5, value);
};

# 494
uint16_t get_low_threshold() {
uint16_t data;
data = as7341_i2c_read(0x84);
data = (as7341_i2c_read(0x85)<<8) | data;
return data;
};
...
uint16_t get_high_threshold() {
uint16_t data;
data = as7341_i2c_read(0x86);
data = (as7341_i2c_read(0x87) <<8) | data;
return data;
};

# 515
void syns_interrupt_sel() {
as7341_i2c_write(0x70, 0x05);
};

# 522
void disabledAll() {
as7341_i2c_write(0x80, 0x02);
};
...
as7341_i2c_write(0xB2, 0x10);
};


bool enable_Special_Interrupt(){
as7341_i2c_write(0xF9, 0x01);
};

bool set_integration_mode(eMode_t *integration_mode) {
as7341_i2c_write(0x70, integration_mode);
};
...
bool set_WTIME(uint8_t value) {
as7341_i2c_write(0x83, value);
};

void INT_MODE(uint8_t mode) {
uint8_t regVal = as7341_i2c_read(0x70);
regVal = regVal & 0xFC;
regVal = regVal | mode;
as7341_i2c_write(0x70, regVal);
}
void set_APERS(as7341_int_cycle_count_t count) {
as7341_i2c_write(0xBD, count);
};
...
I2C_Start();
I2C_Write((0x39 << 1) | 0x01);
readingL = I2C_Read(ack);
readingH = I2C_Read(nack);
readingH = readingH << 8;
